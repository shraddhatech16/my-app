    ...
    <div>
        ...
        <div className="container" style={{"marginBottom": "70px"}}>
          ...
          <div className="mb-3">
            ...
            <input name="blogtitle" ref={blogtitle} type="name" className="form-control" id="exampleFormControlInput1" placeholder="Enter Blogtitle "/>
          </div>
          <div className="mb-4">
            ...
            <input name="body" ref={blogtitle} type="name" className="form-control" id="exampleFormControlInput1" placeholder="Enter Body "/>
